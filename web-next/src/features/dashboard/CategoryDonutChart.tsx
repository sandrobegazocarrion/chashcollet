    ...
    <Card className="min-h-[320px]">
      ...
      {cats.length === 0 ? (
        ...
        <div className="flex flex-col items-center gap-5">
          <div className="relative h-[164px] w-[164px] shrink-0 rounded-full" style={{ background: `conic-gradient(${stops.join(', ')})` }}>
          ...
          <ul className="flex w-full max-w-xs flex-col gap-2">
            {cats.map((c) => {
              ...
              return (
                <li key={c} className="flex items-center gap-2 text-xs text-[var(--text-muted)]">
