...
// Exportado para que <MoreSheet> reuse exactamente esta lista en mobile, en vez de
// duplicarla.
...
// Riel de escritorio únicamente — en mobile la navegación secundaria vive en
// <MoreSheet>, no acá. Antes este mismo componente doblaba como drawer lateral en
// mobile (abierto desde "Más"), pero mezclar riel + bottom tab bar + drawer lateral
// en la misma jerarquía se sentía como un patrón de escritorio injertado.
export function Sidebar({ active, onChange, showAdmin, onQuickAdd, online }: SidebarProps) {
